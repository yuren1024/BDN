...
import torch
import yaml
from utils import set_seed,train_model,dataloader_set,model_resume,set_gpus
...
## DataLoaders
train_loader,val_loader = dataloader_set(train_dir,val_dir,opt)

if __name__ == '__main__':
    train_model(model_restored,train_loader,val_loader,scheduler,optimizer
